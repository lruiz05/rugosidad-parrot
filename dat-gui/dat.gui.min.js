    ...
    var d = /(\d+(\.\d+)?)px/,
        f = {
            ...
            addClass: function(a, d) {
                ...
                else if (a.className !== d) { var b = a.className.split(/ +/); - 1 == b.indexOf(d) && (b.push(d), a.className = b.join(" ").replace(/^\s+/, "").replace(/\s+$/, "")) }
                return f
            },
...
dat.controllers.OptionController = function(e, a, b) {
    ...
    b.extend(d.prototype, e.prototype, {
        ...
        updateDisplay: function() { this.__select.value = this.getValue(); return d.superclass.prototype.updateDisplay.call(this) }
    });
    return d
...
dat.GUI = dat.gui.GUI = function(e, a, b, d, f, c, p, k, l, q, n, r, y, g, h) {
    ...
    function s(a, d, b) {
        ...
        } else b instanceof c ? (g.bind(d, "click", function() { g.fakeEvent(b.__checkbox, "click") }), g.bind(b.__checkbox, "click", function(a) { a.stopPropagation() })) :
    ...
    m.CLASS_DRAG = "drag";
    m.DEFAULT_WIDTH = 245;
    m.TEXT_CLOSED = "Cerrar Controles";
    ...
    h.extend(m.prototype, {
        ...
        revert: function(a) {
            h.each(this.__controllers, function(b) { this.getRoot().load.remembered ? v(a || this.getRoot(), b) : b.setValue(b.initialValue) }, this);
